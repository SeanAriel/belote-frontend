//
//  IPhoneGameViewController.swift
//  Belote
//
...
final class IPhoneGameViewController: UIViewController {
    @IBOutlet private weak var sceneView: SKView!
    @IBOutlet private weak var backgroundView: UIView!
    @IBOutlet private weak var setupGameVIew: IPhoneSetupGameView!
    ...
    private func setupScene() {
        guard let scene = scene, let view = sceneView else { return }
...
extension IPhoneGameViewController: IPhoneSetupGameViewDelegate {
    func didTapContinueButton(_ view: IPhoneSetupGameView, difficulty: Int) {
        setupScene()
    }
}
...
extension IPhoneGameViewController: LegalActionsViewDelegate {
...
extension IPhoneGameViewController: GameSceneDelegate {
    func gameOver() {
        print("-----game over")
