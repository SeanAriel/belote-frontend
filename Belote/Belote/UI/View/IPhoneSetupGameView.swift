...
protocol IPhoneSetupGameViewDelegate: AnyObject {
    func didTapContinueButton(_ view: IPhoneSetupGameView, difficulty: Int)
}

class IPhoneSetupGameView: UIView, NibLoadable {
    ...
    weak var delegate: IPhoneSetupGameViewDelegate?
